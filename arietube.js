...
⭔ Url : ${anu.url}`,
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) throw `Example : ${prefix + command} 6283822910734`
...
╟👨‍👨‍👧‍👧*𝐆𝐜𝐁𝐨𝐭:*
╟https://chat.whatsapp.com/CDHRtY4JP2TD1XpF96wQLR
╚═══❖•ೋ°
╔═.✵.════ 𝐆𝐑𝐔𝐏 𝐌𝐄𝐍𝐔 ❊╌──┈⊰᯽⊱
╟📤 ${prefix}linkgroup
